...
The Military Grid Reference System (MGRS), sometimes called the ‘UTM grid’, is often used to define grid cells with a certain dimension (for example 1 km x 1 km) in biodiversity monitoring. Background information can be found [here](https://github.com/inbo/tutorials/blob/mgrs/content/articles/spatial_mgrs/index.md).  
