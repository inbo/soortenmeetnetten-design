...
We maken een 250 m x 250 m grid en selecteren de punten die binnen bwk-polygonen met geschikt leefgebied liggen en/of met aanwezigheid van de soort
...
steekproefkader_sc4 <- steekproefkader_grid %>%
  filter(round(prop_leefgebied, 2) >= 0.5)
