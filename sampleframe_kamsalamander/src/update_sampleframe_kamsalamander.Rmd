...
```{r}
steekproefkader_kamsalamander_gebieden_ranking <- st_read(file.path(fileman_up("soortenmeetnetten-data"), "gis/steekproefkader/kamsalamander"), "Kamsalamander_steekproefkader_versie2018-01-05_AanvIL_polygoon_v5_00500")
...
steekproefkader_kamsalamander_punten_ranking <- st_read(file.path(fileman_up("soortenmeetnetten-data"), "gis/steekproefkader/kamsalamander"), "Kamsalamander_steekproefkader_versie2018-01-05_AanvIL_punten_v5_00500") %>%
  st_transform(31370) %>%
...
steekproefkader_kamsalamander <- st_read(file.path(fileman_up("soortenmeetnetten-data"), "gis/steekproefkader/kamsalamander"), "Kamsalamander_steekproefkader_WGS84_versie2019-03-07")
